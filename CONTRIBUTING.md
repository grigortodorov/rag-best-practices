...
1. Open an issue describing the gap, outdated advice, or unclear section.
2. Or submit a pull request with concrete doc edits.
...
- `docs/` — numbered guides (`01`–`08`)
- `examples/` — checklists, schemas, and pipeline sketches
